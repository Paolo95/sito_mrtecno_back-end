...
router.post('/barterAcceptedStripe', tokenVerify, async (req, res) => {

    const result = await barter_controller.barterAcceptedStripe(req);
...
router.post('/getRecentBarters', tokenVerify, isAdmin , async (req, res) => {
    
    const result = await barter_controller.getRecentBarters();
...
router.post('/barterRefused', tokenVerify, async (req, res) => {

    const result = await barter_controller.barterRefused(req);
